...
/*
	if(ctx.get_src_reader()->matches_unique(L"addi")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"addi");
		ctx.get_src_reader()->advance(4);

	} else if(ctx.get_src_reader()->matches_unique(L"addiu")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"addiu");
		ctx.get_src_reader()->advance(5);

	} else if(ctx.get_src_reader()->matches_unique(L"beq")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"beq");
		ctx.get_src_reader()->advance(3);

	} else if(ctx.get_src_reader()->matches_unique(L"bne")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"bne");
		ctx.get_src_reader()->advance(3);

	} else if(ctx.get_src_reader()->matches_unique(L"lbu")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"lbu");
		ctx.get_src_reader()->advance(3);

	} else if(ctx.get_src_reader()->matches_unique(L"lhu")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"lhu");
		ctx.get_src_reader()->advance(3);

	} else if(ctx.get_src_reader()->matches_unique(L"lui")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"lui");
		ctx.get_src_reader()->advance(3);

	} else if(ctx.get_src_reader()->matches_unique(L"lw")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"lw");
		ctx.get_src_reader()->advance(2);

	} else if(ctx.get_src_reader()->matches_unique(L"ori")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"ori");
		ctx.get_src_reader()->advance(3);

	} else if(ctx.get_src_reader()->matches_unique(L"sb")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"sb");
		ctx.get_src_reader()->advance(2);

	} else if(ctx.get_src_reader()->matches_unique(L"sh")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"sh");
		ctx.get_src_reader()->advance(2);

	} else if(ctx.get_src_reader()->matches_unique(L"slti")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"slti");
		ctx.get_src_reader()->advance(4);

	} else if(ctx.get_src_reader()->matches_unique(L"sltiu")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"sltiu");
		ctx.get_src_reader()->advance(5);

	} else if(ctx.get_src_reader()->matches_unique(L"sw")){
		tok = new i_instr_tok(ctx.get_src_reader()->get_current_row(),
			ctx.get_src_reader()->get_current_col());
		tok->set_raw_tok(L"sw");
		ctx.get_src_reader()->advance(2);
