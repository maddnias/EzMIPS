...
mips_token_ptr pseudo_instr_handler::parse_token(parser_ctx &ctx, wstring buff){	
	...
	//if(ctx.get_src_reader()->matches_unique(L"blt")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"blt");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"bgt")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"bgt");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"ble")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"ble");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"neg")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"neg");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"not")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"not");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"bge")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"bge");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"li")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"li");
	//	ctx.get_src_reader()->advance(2);

	//} else if(ctx.get_src_reader()->matches_unique(L"la")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"la");
	//	ctx.get_src_reader()->advance(2);

	//} else if(ctx.get_src_reader()->matches_unique(L"move")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"move");
	//	ctx.get_src_reader()->advance(4);

	//} else if(ctx.get_src_reader()->matches_unique(L"sge")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"sge");
	//	ctx.get_src_reader()->advance(3);

	//} else if(ctx.get_src_reader()->matches_unique(L"sgt")){
	//	tok = new pseudo_instr_tok(ctx.get_src_reader()->get_current_row(),
	//		ctx.get_src_reader()->get_current_col());
	//	tok->set_raw_tok(L"sgt");
	//	ctx.get_src_reader()->advance(3);
